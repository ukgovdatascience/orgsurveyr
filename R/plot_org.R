...
#' @param df summarised metrics for the units in the network as generated by calc_summary_df. If NULL
#'  the fill_var comes from the nodes data frame in the tidygraph object (data frame)
